...
Como era de esperarse la mayor cantidad de ventas se concentra en los supermercados que en las pequeñas tiendas de comestibles, además podemos visualizar si tenemos datos atípicos.
...
xyplot( Item_Outlet_Sales~ Item_MRP| Item_Fat_Content, data =data, type =c("p" , "r "),
        main="Digrama de dispersicón de las variables Ventas y MRP por contenido de grasa", 
